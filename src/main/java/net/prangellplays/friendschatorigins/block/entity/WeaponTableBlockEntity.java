...
public class WeaponTableBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public WeaponTableBlockEntity(BlockPos pos, BlockState state) {
        super(FriendsChatOriginsBlockEntities.WEAPON_TABLE_BLOCK_ENTITY, pos, state);
    ...
    private void craftItem() {
        ...
        ItemStack result = new ItemStack(FriendsChatOriginsItems.WEAPON_UPGRADE_SMITHING_TEMPLATE);
    ...
    private boolean hasRecipe() {
        ItemStack result = new ItemStack(FriendsChatOriginsItems.WEAPON_UPGRADE_SMITHING_TEMPLATE);
        boolean hasInput = getStack(INPUT_SLOT).getItem() == FriendsChatOriginsItems.WEAPON_UPGRADE_SMITHING_TEMPLATE;
