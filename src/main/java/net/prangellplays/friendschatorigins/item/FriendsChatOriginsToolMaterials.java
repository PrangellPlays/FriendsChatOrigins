...
public enum FriendsChatOriginsToolMaterials implements ToolMaterial {
    ...
    FriendsChatOriginsToolMaterials(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
