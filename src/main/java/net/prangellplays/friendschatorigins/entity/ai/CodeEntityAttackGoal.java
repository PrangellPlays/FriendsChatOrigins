package net.prangellplays.friendschatorigins.entity.ai;
...
public class CodeEntityAttackGoal extends MeleeAttackGoal {
    private final CodeEntity entity;
    private int attackDelay = 5;
    private int ticksUntilNextAttack = 5;
    private boolean shouldCountTillNextAttack = false;

    public CodeEntityAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((CodeEntity) mob);
    }
